...
/**
 * This class is taken near verbatim (changes marked with **BBDFOF** comment markers) from:
 *
 * lessphp v0.3.8
...
class BBDFOFLess
{
	...
	protected function injectVariables($args)
	{
		$this->pushEnv();
		/** BBDFOF -- BEGIN CHANGE * */
		$parser = new BBDFOFLessParser($this, __METHOD__);
		/** BBDFOF -- END CHANGE * */
	...
	{
		/** BBDFOF -- BEGIN CHANGE * */
		$parser = new BBDFOFLessParser($this, $name);
		/** BBDFOF -- END CHANGE * */
	...
	{
		/** BBDFOF -- BEGIN CHANGE * */
		$className = "BBDFOFLessFormatterLessjs";
		/** BBDFOF -- END CHANGE * */
		if (!empty($this->formatterName))
		{
			...
			/** BBDFOF -- BEGIN CHANGE * */
			$className = "BBDFOFLessFormatter" . ucfirst($this->formatterName);
			/** BBDFOF -- END CHANGE * */
		}
