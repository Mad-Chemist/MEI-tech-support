...
class BBDFOFTemplateUtils
{
	 ...
	 *
	 * @see BBDFOFTemplateUtils::parsePath
	 */
	 ...
	 * written to the media/lib_BBDFOF/compiled directory of your site. If the file
	...
	public static function addLESS($path, $altPath = null, $returnPath = false)
	{
		...
		if (is_null($sanityCheck))
		{
			...
			if (!is_dir(JPATH_SITE . '/media/lib_BBDFOF/compiled/'))
			{
				$sanityCheck = JFolder::create(JPATH_SITE . '/media/lib_BBDFOF/compiled/');
			}
			else
			{
				$sanityCheck = true;
		...
		$cachedPath = JPATH_SITE . '/media/lib_BBDFOF/compiled/' . $id . '.css';

		// Get the LESS compiler
		$lessCompiler = new BBDFOFLess();
		...
		$url = $base_url . '/media/lib_BBDFOF/compiled/' . $id . '.css';
	 ...
	 *
	 * <code>
	 * <?php echo BBDFOFTemplateutils::route('view=categories&layout=tree'); ?>
	 * </code>
	 *
	 * Result:
