...
/**
 * The BBDFOFInflector is an adaptation of the Akelos PHP Inflector which is a PHP
 * port from a Ruby on Rails project.
 */

/**
 * BBDFOFInflector to pluralize and singularize English nouns.
 */
class BBDFOFInflector
{
