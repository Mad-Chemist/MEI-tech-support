...
/**
 * An interface for BBDFOFFormHeader fields, used to define the filters and the
 * elements of the header row in repeatable (browse) views
 */
abstract class BBDFOFFormHeader
{
	...
	/**
	 * The BBDFOFForm object of the form attached to the header field.
	 *
	 * @var    BBDFOFForm
	 * @since  2.0
	 */
	 ...
	 *
	 * @param   BBDFOFForm  $form  The form to attach to the form field object.
	 *
	 * @since   2.0
	 */
	public function __construct(BBDFOFForm $form = null)
	{
		// If there is a form passed into the constructor set the form and form control properties.
		if ($form instanceof BBDFOFForm)
		{
			$this->form = $form;
		}
	}
	 ...
	 *
	 * @param   BBDFOFForm  $form  The JForm object to attach to the form field.
	 *
	 * @return  BBDFOFFormHeader  The form field object so that the method can be used in a chain.
	 *
	 * @since   2.0
	 */
	public function setForm(BBDFOFForm $form)
	{
		$this->form = $form;
	...
	/**
	 * Method to attach a BBDFOFForm object to the field.
	 *
	...
	protected function getLabel()
	{
		...
		if (empty($title))
		{
			...
			$title = $params['option'] . '_' .
				BBDFOFInflector::pluralize($params['view']) . '_FIELD_' .
