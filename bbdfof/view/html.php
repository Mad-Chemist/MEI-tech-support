 ...
 */
class BBDFOFViewHtml extends BBDFOFView
{
	...
	public function display($tpl = null)
	{
		...
		if(!$isCli)
		{
			$toolbar = BBDFOFToolbar::getAnInstance($this->input->getCmd('option', 'com_foobar'), $this->config);
	...
	protected function preRender()
	{
		...
		if (!($renderer instanceof BBDFOFRenderAbstract))
		{
			$this->renderLinkbar();
		}
		else
