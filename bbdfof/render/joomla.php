 ...
 */
class BBDFOFRenderJoomla extends BBDFOFRenderAbstract
{
...
ENDJAVASCRIPT;
	...
	protected function renderButtons($view, $task, $input, $config = array())
	{
		...
		echo '<div id="BBDFOFHeaderHolder">', $bar_content, $title, '<div style="clear:both"></div>', '</div>';
	}
}